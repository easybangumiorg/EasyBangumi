...
// @versionCode 20000
// @libVersion 15
// @cover https://www.fqdm.cc/favicon.ico
...
var DEFAULT_BASE_URL = "https://www.fqdm.cc/";
var SEARCH_URL = "https://www.fqdm.cc/index.php/vod/search/wd/@keyword.html";
var SEARCH_LIST_XPATH = "//div[@class='module-items module-card-items']/div[contains(@class, 'module-card-item')]";
var SEARCH_NAME_XPATH = ".//div[@class='module-card-item-title']/a";
var SEARCH_RESULT_XPATH = ".//div[@class='module-card-item-title']/a";
var CHAPTER_ROADS_XPATH = "//div[contains(@class,'module-play-list-content')]";
var CHAPTER_RESULT_XPATH = "//a[contains(@class,'module-play-list-link')]";
var USER_AGENT = "";
var REFERER = "";
var USE_POST = false;
var USE_LEGACY_PARSER = true;
