...
1. **Version:** read `buildSrc/src/main/java/com/heyanle/buildsrc/Android.kt`. Require positive `versionCode`, nonblank `versionName`, and a versionCode greater than or equal to the baseline release's value. State both values.
