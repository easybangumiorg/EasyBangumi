...
object Version {
    ...
    const val androidx_fragment_ktx = "1.6.0"
    ...
    const val androidx_window = "1.2.0-alpha02"
    ...
    const val easy_player = "1.2.0"

    const val accompanist = "0.31.2-alpha"
    const val navigation_compose = "2.7.0-beta01"
    ...
    const val compose_animation = "1.5.0-beta02"
    const val compose_compiler = "1.4.3"
    const val compose_foundation = "1.5.0-beta02"
    const val compose_material = "1.5.0-beta02"
    const val compose_material3 = "1.2.0-alpha02"
    const val compose_runtime = "1.5.0-beta02"
    const val compose_ui = "1.5.0-beta02"
