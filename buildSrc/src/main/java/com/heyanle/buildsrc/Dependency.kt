...
object Version {
    const val androidx_activity_ktx = "1.7.1"
    const val androidx_fragment_ktx = "1.5.7"
    ...
    const val androidx_window = "1.1.0-rc01"
    ...
    const val compose_animation = "1.5.0-alpha04"
    const val compose_compiler = "1.4.3"
    const val compose_foundation = "1.5.0-alpha04"
    const val compose_material = "1.5.0-alpha04"
    const val compose_material3 = "1.2.0-alpha01"
    const val compose_runtime = "1.5.0-alpha04"
    const val compose_ui = "1.5.0-alpha04"
