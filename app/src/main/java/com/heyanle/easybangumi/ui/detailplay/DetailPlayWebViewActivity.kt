...
import com.heyanle.easybangumi.databinding.ActivityDetailWebPlayBinding
...
/**
 * Created by HeYanLe on 2021/10/21 21:19.
 * https://github.com/heyanLE
 */
class DetailPlayWebViewActivity: BaseActivity() {
    ...
    companion object{
        ...
        fun start(activity: Context, bangumi: Bangumi){
            ...
            activity.start<DetailPlayWebViewActivity> {
    ...
    class DetailHandler(
        detailPlayActivity: DetailPlayWebViewActivity
    ...
    private val binding: ActivityDetailWebPlayBinding by lazy {
        ActivityDetailWebPlayBinding.inflate(LayoutInflater.from(this))
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.web.isVerticalScrollBarEnabled = false
        binding.web.isHorizontalScrollBarEnabled = false
        ...
        binding.web.settings.javaScriptEnabled = true
        binding.web.settings.pluginState = WebSettings.PluginState.ON
        binding.web.settings.domStorageEnabled = true
        binding.web.settings.setRenderPriority(WebSettings.RenderPriority.HIGH)
    ...
    override fun onPause() {
        Jzvd.goOnPlayOnPause()
        Log.i("DetailPlayWebActivity","onPause")
        super.onPause()
        //Jzvd.releaseAllVideos()
    }
