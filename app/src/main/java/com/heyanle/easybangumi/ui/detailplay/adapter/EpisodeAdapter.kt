...
class EpisodeAdapter (
    ...
    override fun onBindViewHolder(holder: EpisodeViewHolder, position: Int) {
        ...
        if(nowSelectIndex == position){
            ...
            holder.binding.episode.setTextColor(getAttrColor(holder.binding.root.context, R.attr.colorOnSecondary))
        }else{
            holder.binding.sourceCard.setCardBackgroundColor(getAttrColor(holder.binding.root.context, R.attr.colorSurface))
            holder.binding.episode.setTextColor(getAttrColor(holder.binding.root.context, R.attr.colorOnSurface))
        }
    }
