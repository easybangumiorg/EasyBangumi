...
class PlayLineAdapter (
    ...
    override fun onBindViewHolder(holder: PlayLineViewHolder, position: Int) {
        ...
        if(selectTitle == titleList[position]){
            ...
            holder.binding.playLine.setTextColor(getAttrColor(holder.binding.root.context, com.google.android.material.R.attr.colorOnSecondary))
        }else{
            ...
            holder.binding.playLine.setTextColor(getAttrColor(holder.binding.root.context, com.google.android.material.R.attr.colorOnSurface))
        }
