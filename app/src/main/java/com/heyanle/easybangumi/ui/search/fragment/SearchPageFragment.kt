...
import com.heyanle.easybangumi.databinding.FragmentRefreshRecyclerBinding
...
class SearchPageFragment(): Fragment(R.layout.fragment_search_page) {
    ...
    val index:Int
    get() {
        return requireArguments().getInt(ARGUMENT_KEY_INDEX, 0)
    }
    ...
    private val pager: Pager<Int, Bangumi> by lazy {
        Pager<Int, Bangumi>(
            ...
            SearchPageSource(ParserFactory.search(sourceKey)!!, activityViewModel.keyword.value?:"")
        }
    }
