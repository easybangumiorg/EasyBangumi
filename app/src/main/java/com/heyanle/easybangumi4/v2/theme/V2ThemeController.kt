...
enum class V2ThemeColor(
    ...
    Jade(
        ...
        night = V2ThemeColorSet(
            accent = Color(0xFF72DCC0),
            onAccent = Color(0xFF063B2F),
    ...
    Ocean(
        ...
        night = V2ThemeColorSet(
            accent = Color(0xFFA8CEFF),
            onAccent = Color(0xFF0E365F),
    ...
    Wisteria(
        ...
        night = V2ThemeColorSet(
            accent = Color(0xFFE2C8FF),
            onAccent = Color(0xFF352057),
