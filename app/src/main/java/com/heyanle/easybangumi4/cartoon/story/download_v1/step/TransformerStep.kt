...
object TransformerStep : BaseStep {
    ...
    private val cartoonDownloadPreference: CartoonDownloadPreference by Inject.injectLazy()
    ...
    override fun invoke() {
        ...
        val countDownLatchII: CountDownLatch = CountDownLatch(1)

        runtime.countDownLatchII = countDownLatchII
