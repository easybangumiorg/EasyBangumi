...
import com.heyanle.easybangumi4.source.utils.network.interceptor.CloudflareInterceptor
import com.heyanle.easybangumi4.source.utils.network.interceptor.CloudflareUserInterceptor
import com.heyanle.easybangumi4.source.utils.network.interceptor.CookieInterceptor
import com.heyanle.easybangumi4.source.utils.network.interceptor.UserAgentInterceptor
...
class OkhttpHelperImpl(
    ...
    private val cloudflareInterceptor by lazy { CloudflareInterceptor(context, networkHelper) }
    private val cloudflareUserInterceptor by lazy { CloudflareUserInterceptor(context, networkHelper, webViewHelper) }
